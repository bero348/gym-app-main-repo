...
export const EXERCISES = {
  ...
  standing_dumbbell_incline_fly: {//added
    type: "accessory",
    meta: {
      environment: "gymhome",
      level: [0, 1, 2],
  ...
  pushups: {//added
    ...
    substitutes: [ "dumbbell bench press", "floor press"],
  },
  dips: {//added
    type: "compound",
    meta: {
  ...
  barbell_bentover_row: {//added
    ...
    substitutes: ["seated row"],
  },
  dumbbell_bentover_row: {//added
    type: "compound",
    meta: {
      environment: "gymhome",
      level: [0, 1, 2],
  ...
  unilaterial_dumbbell_row: {//added
    type: "compound",
    meta: {
      environment: "gymhome",
      level: [0, 1, 2],
    ...
    substitutes: ["unilateral seated row"],
  },
  chest_supported_dumbbell_row: {//added
    type: "accessory",
    meta: {
      environment: "gym",
      level: [0, 1, 2],
  ...
  seated_dumbbell_overhead_press: {//added
    type: "compound",
    meta: {
      environment: "gymhome",
      level: [0, 1, 2],
    ...
    substitutes: ["barbell overhead press", "arnold_dumbbell_press"],
  },
  barbell_overhead_press: {//added
    type: "compound",
    meta: {
      environment: "gymhome",
      level: [0, 1, 2],
    ...
    substitutes: ["arnold_dumbbell_press"],
  },
  dumbbell_lateral_raise: {//added
    type: "accessory",
    meta: {
      environment: "gymhome",
      level: [0, 1, 2],
    ...
    substitutes: ["unilateral cable raise"],
  },
  dumbbell_front_raise: {//added
    type: "accessory",
    meta: {
      environment: "gymhome",
      level: [0, 1, 2],
    ...
    substitutes: ["unilateral cable raise","cable_rope_front_raise"],
  },
  cable_rope_front_raise: {//added
    type: "accessory",
    meta: {
      environment: "gymhome",
      level: [0, 1, 2],
    ...
    substitutes: ["dumbbell front raise"],
  },
  unilateral_cable_raise: {//added
    type: "accessory",
    meta: {
      environment: "gymhome",
      level: [0, 1, 2],
  ...
  bentover_dumbbell_push_aparts: {//added
    type: "accessory",
    meta: {
      environment: "gymhome",
      level: [0, 1, 2],
  ...
  chest_supported_dumbbell_face_pulls: {//added
    type: "accessory",
    meta: {
      environment: "gymhome",
      level: [0, 1, 2],
  ...
  chest_supported_barbell_face_pulls: {//added
    type: "accessory",
    meta: {
      environment: "gymhome",
      level: [0, 1, 2],
    ...
    substitutes: ["chest_supported_dumbbell_face_pulls", "cable push aparts"],
  },
  arnold_dumbbell_press: {//added
    type: "accessory",
    meta: {
      environment: "gymhome",
      level: [0, 1, 2],
    ...
    substitutes: ["barbell overhead press", "seated_dumbbell_overhead_press"],
  },
  lyings_ys: {//added
    type: "accessory",
    meta: {
  ...
  hamstring_back_extensions: {//added
    type: "accessory",
    meta: {
      environment: "gym",
      level: [0, 1, 2],
    ...
    substitutes: [ "seated hamstring curl"],
  },
  unilateral_dumbbell_rdls: {//added
    type: "accessory",
    meta: {
      environment: "gymhome",
      level: [0, 1, 2],
    ...
    substitutes: [ "hamstring back extensions"],
  },
  seated_hamstring_curl: {//added
    type: "accessory",
    meta: {
      environment: "gym",
      level: [0, 1, 2],
  ...
  tbar_rdls: {//added
    ...
    substitutes: ["unilateral dumbbell rdls"],
  },
  lying_machine_hamstring_curls: {//added
    type: "accessory",
    meta: {
      environment: "gym",
      level: [0, 1, 2],
  ...
  lying_dumbbell_hamstring_curls: {//added
    type: "accessory",
    meta: {
      environment: "gymhome",
      level: [0, 1, 2],
 ...
 //
  ...
  unilateral_hammer_cable_curl: {//added
    type: "accessory",
    meta: {
      environment: "gymhome",
      level: [0, 1, 2],
  ...
  unilateral_cable_pushdown: {//added
    type: "accessory",
    meta: {
      environment: "gymhome",
      level: [0, 1, 2],
  ...
  unilateral_cable_push_aways: {//added
    type: "accessory",
    meta: {
      environment: "gymhome",
      level: [0, 1, 2],
  ...
  hanging_knee_raises: {//added
    ...
    substitutes: ["lying_leg_lifts"],
  },
  mountain_climbers: {//added
    type: "accessory",
    meta: {
      environment: "gymhome",
      level: [0, 1, 2],
  ...
  banana_hold: { //added
    ...
    substitutes: ["plank", "lying_leg_lifts"],
  },
};
